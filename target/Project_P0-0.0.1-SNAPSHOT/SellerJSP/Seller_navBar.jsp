...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container-fluid">
        <a class="navbar-brand" href="/Project_P0/SellerJSP/Seller_Main.jsp">Dashboard</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item" style="margin: 0 28px;">
                    <a class="nav-link" href="/Project_P0/SellerAddProductServlet">Add Products</a>
                </li>
                <li class="nav-item" style="margin: 0 28px;">
                    <a class="nav-link" href="/Project_P0/SellerShowProducts">My Products</a>
                </li>
                <li class="nav-item dropdown" style="margin: 0 28px;">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="ordersDropdown">
                        <li><a class="dropdown-item" href="/Project_P0/SellerReceivedOrder">Received</a></li>
                        <li><a class="dropdown-item" href="/Project_P0/JSP/SellerSuccessfulOrders.jsp">Completed Orders</a></li>
                    </ul>
                </li>
                ...
                <li class="nav-item dropdown" style="margin: 0 28px;">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="helpDropdown">
                        ...
                        <li><a class="dropdown-item" href="/Project_P0/JSP/ErrorPage.jsp">Technical Support</a></li>
                    </ul>
                </li>
                <li class="nav-item dropdown" style="margin: 0 15px;">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="profileDropdown">
                        <li><a class="dropdown-item" href="/Project_P0/SellerUpdateDetailsServlet">Update Profile</a></li>
