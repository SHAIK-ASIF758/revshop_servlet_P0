...
<head>
    ...
    <style>
    body{
    background-image: url('/Project_P0/Images/MainRevature.png'); /* Path to the background image */
...
<div class="container mt-5" >
        ...
        <div id="customerForm" style="display:none;" class="mt-4">
            ...
            <form action="/Project_P0/CustomerRegistrationServlet" method="post" class="form-group">
        ...
        <div id="sellerForm" style="display:none;" class="mt-4">
            ...
            <form action="/Project_P0/SellerRegistrationServlet" method="post" class="form-group">
        ...
        <div class="text-center mt-4">
            <p>Already have an account? <a href="/Project_P0/JSP/Login_page.jsp">Login</a></p>
        </div>
    </div>
